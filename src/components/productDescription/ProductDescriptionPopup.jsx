...
import "./ProductDescriptionPopup.css";
  ...
  return (
    <div className="popup-container">
      <div className="main-container">
        <div className="popup-container-elememts">
          <svg
          ...
          <h3 className="popupTitle">About this space </h3>
          <span>{descriptionSpace}</span>
          <h4 className="titles">The Space</h4>
          <span>{descriptionPlace}</span>
          <h4 className="titles">Guest access</h4>
          <span>{guestAccess}</span>
          <h4 className="titles">Other things to note</h4>
